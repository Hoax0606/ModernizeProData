    ...
    static final class WorkerI18n {
        private static final java.util.Map<String, java.util.Map<String, String>> DICT = java.util.Map.of(
                "en", java.util.Map.ofEntries(
                        ...
                        java.util.Map.entry("url.update.availableBody",  "A newer version ({latest}) is available. Current: {current}. It will be applied automatically after this session."),
                ...
                "ko", java.util.Map.ofEntries(
                        ...
                        java.util.Map.entry("url.update.availableBody",  "새 버전 {latest} 이 있습니다. 현재: {current}. 이번 세션 이후 자동으로 적용됩니다."),
                ...
                "ja", java.util.Map.ofEntries(
                        ...
                        java.util.Map.entry("url.update.availableBody",  "新しいバージョン {latest} があります。現在: {current}。このセッション後に自動で適用されます。"),
